...
final class Intro
{
	...
	{
		return Color::clr("Usage:", "brown") . PHP_EOL.
				"  command [options] [arguments]" . PHP_EOL;		
	}

	private function optionInfo()
	{
		return Color::clr("Options:", "brown") . PHP_EOL .
"  ".Color::clr("-h, --help", "green")."            Display this help message
